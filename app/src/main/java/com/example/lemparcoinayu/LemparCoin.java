package com.example.lemparcoinayu;
...
public class LemparCoin extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        buttonRepeat=(Button)findViewById(R.id.button_2);
        buttonExit=(Button)findViewById(R.id.button_3);
    ...
    public void onClick(View view){
        if(view==buttonToss) {
            Log.d("CLICK_EVENT", "Toss button Clickend!");
